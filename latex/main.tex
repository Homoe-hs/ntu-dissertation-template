...
\usepackage{amsmath, amsthm}                  % 数学支持
\usepackage{amssymb}                          % 解决宏包冲突
...
\usepackage{ragged2e}
% add-on
\usepackage{algorithm}                        % 增加对算法展示的支持
\usepackage{algpseudocode}                    % 增加对伪代码的支持
% 长表格
\usepackage{longtable}                        % 增加对长表格的支持
